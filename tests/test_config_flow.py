...
async def test_user_step_creates_entry(hass: HomeAssistant) -> None:
    ...
    # ponytail: the flow needs none of the manifest deps; mark them loaded so creating the
    # entry does not try to set up panel_custom/frontend in the bare test environment.
